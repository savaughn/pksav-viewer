        ...
        <div>
            ...
            <main>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    ...
                    It currently supports only Generation 1 and Generation 2 Pokemon games with a .sav format. Pokemon Crystal currently does not work. Support is in Progress.
                </p>
                </div>                
            </main>
        </div>
